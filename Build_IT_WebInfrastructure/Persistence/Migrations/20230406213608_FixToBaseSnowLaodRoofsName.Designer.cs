...
namespace Build_IT_WebInfrastructure.Persistence.Migrations
{
    ...
    [Migration("20230406213608_FixToBaseSnowLaodRoofsName")]
    partial class FixToBaseSnowLaodRoofsName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("AltitudeAboveSea")
                        .HasColumnType("float");
                    ...
                    b.Property<int>("CurrentTopography")
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("OverallHeatTransferCoefficient")
                        .HasColumnType("float");

                    b.Property<int>("SnowLoadId")
                        .HasColumnType("int");

                    b.Property<double?>("TempreatureDifference")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("SnowLoadId")
                        .IsUnique();

                    b.ToTable("BaseSnowLoadRoofs", "SnowLoads");
                });

            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.ProjectSnowLoad", b =>
                {
                    b.Property<int>("ProjectId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProjectId", "SnowLoadId");

                    b.HasIndex("SnowLoadId");

                    b.ToTable("ProjectSnowLoads", "SnowLoads");
                });

            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.SnowLoad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SnowLoadRoofId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("SnowLoads", "SnowLoads");
                });
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.CylindricalRoof", b =>
                {
                    b.HasBaseType("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof");

                    b.Property<double>("DriftLength")
                        .HasColumnType("float");
                    ...
                    b.ToTable("CylindricalRoofs", "SnowLoads");
                });

            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.DriftingAtProjectionsObstructions", b =>
                {
                    b.HasBaseType("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof");
                    ...
                    b.Property<double>("ObstructionHeight")
                        .HasColumnType("float");

                    b.ToTable("DriftingsAtProjectionsObstructions", "SnowLoads");
                });

            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.MonopitchRoof", b =>
                {
                    b.HasBaseType("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof");
                    ...
                    b.Property<bool>("SnowFences")
                        .HasColumnType("bit");

                    b.ToTable("MonopitchRoofs", "SnowLoads");
                });

            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.MultiSpanRoof", b =>
                {
                    b.HasBaseType("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof");

                    b.Property<double>("LeftSlope")
                        .HasColumnType("float");

                    b.Property<bool>("LeftSnowFences")
                        .HasColumnType("bit");

                    b.Property<double>("RightSlope")
                        .HasColumnType("float");

                    b.Property<bool>("RightSnowFences")
                        .HasColumnType("bit");

                    b.ToTable("MultiSpanRoofs", "SnowLoads");
                });

            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.PitchedRoof", b =>
                {
                    b.HasBaseType("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof");
                    ...
                    b.ToTable("PitchedRoofs", "SnowLoads");
                });

            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.RoofAbuttingToTallerConstruction", b =>
                {
                    b.HasBaseType("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof");
                    ...
                    b.Property<bool>("SlopeOfHigherRoof")
                        .HasColumnType("bit");

                    b.Property<bool>("SnowFencesOnHigherRoof")
                        .HasColumnType("bit");

                    b.Property<bool>("WidthOfLowerBuilding")
                        .HasColumnType("bit");

                    b.Property<double>("WidthOfUpperBuilding")
                        .HasColumnType("float");

                    b.ToTable("RoofsAbuttingToTallerConstructions", "SnowLoads");
                });

            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.Snowguards", b =>
                {
                    b.HasBaseType("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof");
                    ...
                    b.Property<double>("SnowLoadOnRoofValue")
                        .HasColumnType("float");

                    b.Property<double>("Width")
                        .HasColumnType("float");

                    b.ToTable("Snowguards", "SnowLoads");
                });

            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.SnowOverhanging", b =>
                {
                    b.HasBaseType("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof");
                    ...
                    b.Property<double>("SnowLayerDepth")
                        .HasColumnType("float");

                    b.ToTable("SnowOverhangings", "SnowLoads");
                });
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", b =>
                {
                    b.HasOne("Build_IT_DataAccess.SnowLoads.Entities.SnowLoad", "SnowLoad")
                        .WithOne("SnowLoadRoof")
                        .HasForeignKey("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", "SnowLoadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SnowLoad");
                });
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.CylindricalRoof", b =>
                {
                    b.HasOne("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", null)
                        .WithOne()
                        .HasForeignKey("Build_IT_DataAccess.SnowLoads.Entities.CylindricalRoof", "Id")
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.DriftingAtProjectionsObstructions", b =>
                {
                    b.HasOne("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", null)
                        .WithOne()
                        .HasForeignKey("Build_IT_DataAccess.SnowLoads.Entities.DriftingAtProjectionsObstructions", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.MonopitchRoof", b =>
                {
                    b.HasOne("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", null)
                        .WithOne()
                        .HasForeignKey("Build_IT_DataAccess.SnowLoads.Entities.MonopitchRoof", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.MultiSpanRoof", b =>
                {
                    b.HasOne("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", null)
                        .WithOne()
                        .HasForeignKey("Build_IT_DataAccess.SnowLoads.Entities.MultiSpanRoof", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.PitchedRoof", b =>
                {
                    b.HasOne("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", null)
                        .WithOne()
                        .HasForeignKey("Build_IT_DataAccess.SnowLoads.Entities.PitchedRoof", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.RoofAbuttingToTallerConstruction", b =>
                {
                    b.HasOne("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", null)
                        .WithOne()
                        .HasForeignKey("Build_IT_DataAccess.SnowLoads.Entities.RoofAbuttingToTallerConstruction", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.Snowguards", b =>
                {
                    b.HasOne("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", null)
                        .WithOne()
                        .HasForeignKey("Build_IT_DataAccess.SnowLoads.Entities.Snowguards", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Build_IT_DataAccess.SnowLoads.Entities.SnowOverhanging", b =>
                {
                    b.HasOne("Build_IT_DataAccess.SnowLoads.Entities.BaseSnowLoadRoof", null)
                        .WithOne()
                        .HasForeignKey("Build_IT_DataAccess.SnowLoads.Entities.SnowOverhanging", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
