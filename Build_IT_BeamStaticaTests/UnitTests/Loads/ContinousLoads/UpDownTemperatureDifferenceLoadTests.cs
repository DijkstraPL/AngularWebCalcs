...
namespace Build_IT_BeamStaticaTests.UnitTests.Loads.ContinousLoads
{
    ...
    public class UpDownTemperatureDifferenceLoadTests
    {
        ...
        public void SetUpData()
        {
            ...
            span.Setup(s => s.Section).Returns(new SectionData { MomentOfInteria = 2, SolidHeight=5 });
            span.Setup(s => s.Material).Returns(new MaterialData { YoungModulus = 3, ThermalExpansionCoefficient=2 });
